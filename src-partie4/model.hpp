...
public:
    ...
    Model( double t_length, unsigned t_discretization, std::array<double,2> t_wind,
           LexicoIndices t_start_fire_position, int rank, int size, MPI_Comm comm, double t_max_wind = 60. );
    ...
    unsigned local_height() const { return m_local_height; }
